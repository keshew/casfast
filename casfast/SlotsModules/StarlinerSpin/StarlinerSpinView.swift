...
struct StarlinerSpinView: View {
    @StateObject var viewModel =  StarlinerSpinViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack {
                        Color(red: 0/255, green: 96/255, blue: 77/255)
                ...
                ZStack {
                    ZStack(alignment: .top) {
                        Color(red: 0/255, green: 96/255, blue: 77/255).opacity(0.8)
                            .frame(height: 80)
                        
                        Color(red: 0/255, green: 96/255, blue: 76/255)
                            .frame(height: 1)
                    }
                }
            }
                ...
                HStack {
                    ...
                    Rectangle()
                        .fill(LinearGradient(colors: [Color(red: 4/255, green: 217/255, blue: 255/255),
                                                      Color(red: 255/255, green: 212/255, blue: 37/255)], startPoint: .leading, endPoint: .trailing))
                        .overlay {
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(                        Color(red: 0/255, green: 96/255, blue: 76/255), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 7) {
