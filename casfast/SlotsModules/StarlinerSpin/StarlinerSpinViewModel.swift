...
class StarlinerSpinViewModel: ObservableObject {
    let contact = StarlinerSpinModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 10
    let allFruits = ["star1", "star2", "star3","star4", "star5", "star6"]
    ...
    let symbolArray = [
        Symbol(image: "star1", value: "200"),
        Symbol(image: "star2", value: "100"),
        Symbol(image: "star3", value: "75"),
        Symbol(image: "star4", value: "50"),
        Symbol(image: "star5", value: "25"),
        Symbol(image: "star6", value: "10")
    ]
