...
class MoonlightManorViewModel: ObservableObject {
    let contact = MoonlightManorModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 10
    let allFruits = ["man1", "man2", "man3","man4", "man5", "man6"]
    ...
    let symbolArray = [
        Symbol(image: "man1", value: "200"),
        Symbol(image: "man2", value: "100"),
        Symbol(image: "man3", value: "75"),
        Symbol(image: "man4", value: "50"),
        Symbol(image: "man5", value: "25"),
        Symbol(image: "man6", value: "10")
    ]
