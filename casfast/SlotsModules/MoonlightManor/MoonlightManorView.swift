...
struct MoonlightManorView: View {
    @StateObject var viewModel =  MoonlightManorViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack {
                        Color(red: 0/255, green: 96/255, blue: 96/255)
                ...
                ZStack {
                    ZStack(alignment: .top) {
                        Color(red: 0/255, green: 96/255, blue: 96/255).opacity(0.8)
                            .frame(height: 80)
                        
                        Color(red: 5/255, green: 217/255, blue: 217/255)
                            .frame(height: 1)
                    }
                }
            }
            ...
            VStack(spacing: 30) {
                HStack {
                    ...
                    Rectangle()
                        .fill(LinearGradient(colors: [Color(red: 75/255, green: 95/255, blue: 217/255),
                                                      Color(red: 5/255, green: 217/255, blue: 217/255)], startPoint: .leading, endPoint: .trailing))
                        .overlay {
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(Color(red: 176/255, green: 38/255, blue: 255/255).opacity(0.4))
                                .overlay {
                                    Text("Moonlight Manor")
                                        .font(.custom("PaytoneOne-Regular", size: 18))
                                        .foregroundStyle(.white)
                                        .shadow(radius: 3)
                                }
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(Color(red: 5/255, green: 217/255, blue: 217/255), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 7) {
