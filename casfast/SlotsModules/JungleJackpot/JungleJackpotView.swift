...
struct JungleJackpotView: View {
    @StateObject var viewModel =  JungleJackpotViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack {
                        Color(red: 10/255, green: 45/255, blue: 1/255)
                ...
                ZStack {
                    ZStack(alignment: .top) {
                        Color(red: 10/255, green: 45/255, blue: 1/255).opacity(0.8)
                            .frame(height: 80)
                        
                        Color(red: 15/255, green: 178/255, blue: 14/255)
                            .frame(height: 1)
                    }
                }
            }
            ...
            VStack(spacing: 30) {
                HStack {
                    ...
                    Rectangle()
                        .fill(LinearGradient(colors: [Color(red: 45/255, green: 139/255, blue: 60/255),
                                                      Color(red: 255/255, green: 215/255, blue: 0/255)], startPoint: .leading, endPoint: .trailing))
                        .overlay {
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(Color(red: 15/255, green: 178/255, blue: 14/255), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 7) {
