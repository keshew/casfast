...
class NeonRoyaleViewModel: ObservableObject {
    let contact = NeonRoyaleModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 10
    let allFruits = ["neo1", "neo2", "neo3","neo4", "neo5", "neo6"]
    ...
    let symbolArray = [
        Symbol(image: "neo1", value: "200"),
        Symbol(image: "neo2", value: "100"),
        Symbol(image: "neo3", value: "75"),
        Symbol(image: "neo4", value: "50"),
        Symbol(image: "neo5", value: "25"),
        Symbol(image: "neo6", value: "10")
    ]
