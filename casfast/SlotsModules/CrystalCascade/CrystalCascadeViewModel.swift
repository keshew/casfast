...
class CrystalCascadeViewModel: ObservableObject {
    let contact = CrystalCascadeModel()
    @Published var slots: [[String]] = []
    @Published var coin =   UserDefaultsManager.shared.coins
    @Published var bet = 10
    @Published var win = 0
    let allFruits = ["cas1", "cas2", "cas3","cas4", "cas5", "cas6"]
    ...
    let symbolArray = [
        Symbol(image: "cas1", value: "200"),
        Symbol(image: "cas2", value: "100"),
        Symbol(image: "cas3", value: "75"),
        Symbol(image: "cas4", value: "50"),
        Symbol(image: "cas5", value: "25"),
        Symbol(image: "cas6", value: "10")
    ]
