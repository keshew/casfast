...
struct SugarySpireView: View {
    @StateObject var viewModel =  SugarySpireViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack {
                        Color(red: 96/255, green: 0/255, blue: 61/255)
                ...
                ZStack {
                    ZStack(alignment: .top) {
                        Color(red: 96/255, green: 0/255, blue: 61/255).opacity(0.6)
                            .frame(height: 80)
            ...
            VStack(spacing: 30) {
                HStack {
                    ...
                    Rectangle()
                        .fill(LinearGradient(colors: [Color(red: 255/255, green: 105/255, blue: 181/255),
                                                      Color(red: 153/255, green: 251/255, blue: 152/255)], startPoint: .leading, endPoint: .trailing))
                        .overlay {
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(Color(red: 96/255, green: 0/255, blue: 61/255), lineWidth: 3)
                                    .overlay {
                                        VStack(spacing: 7) {
