...
struct LanternCascadeView: View {
    @StateObject var viewModel =  LanternCascadeViewModel()
        ...
        ZStack {
            ZStack(alignment: .bottom) {
                ZStack(alignment: .top) {
                    ...
                    ZStack {
                        Color(red: 96/255, green: 45/255, blue: 0/255)
                ...
                ZStack {
                    ZStack(alignment: .top) {
                        Color(red: 96/255, green: 45/255, blue: 0/255).opacity(0.8)
                            .frame(height: 80)
                        
                        Color(red: 255/255, green: 185/255, blue: 52/255)
                            .frame(height: 1)
                    }
                }
            }
            ...
            VStack(spacing: 30) {
                HStack {
                    ...
                    Rectangle()
                        .fill(LinearGradient(colors: [Color(red: 255/255, green: 157/255, blue: 0/255),
                                                      Color(red: 255/255, green: 77/255, blue: 0/255)], startPoint: .leading, endPoint: .trailing))
                        .overlay {
                            RoundedRectangle(cornerRadius: 16)
                                .stroke(Color(red: 176/255, green: 38/255, blue: 255/255).opacity(0.4))
                                .overlay {
                                    Text("LANTERN CASCADE")
                                        .font(.custom("PaytoneOne-Regular", size: 18))
                                        .foregroundStyle(.white)
                                        .shadow(radius: 3)
                                }
                        ...
                        Rectangle()
                            ...
                            .overlay {
                                RoundedRectangle(cornerRadius: 14)
                                    .stroke(Color(red: 255/255, green: 185/255, blue: 52/255) , lineWidth: 3)
                                    .overlay {
                                        HStack(spacing: 15) {
                                            ForEach(0..<5, id: \.self) { index in
                                                ...
                                                .opacity(viewModel.selectedIndex == index ? 0.5 : 1)
                                            }
                                        }
                                    }
                            }
